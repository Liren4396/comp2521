 ...
 * sets the top-left and bottom-right entries to false.
 *
...
/**
 * Allocates and returns a 2D array/matrix of Cells with the give number
 * of rows and columns. All entries are initialised to (0, 0). It is the
